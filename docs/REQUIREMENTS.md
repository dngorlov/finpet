...
- **Resolved:** no Прогресс screen (ADR-0004). Итоги on Дом is the reopenable record (last closed day + overall counts). Журнал is a Деньги section. Словарик on Карта has «Слова» (the 10 terms) and «Уроки» (a compact list of open уроки; tapping one opens its unscored cards). Key terms: Баланс, Копилка, Цель, План, Обязательные расходы, Желаемые расходы, Сытость, Счастье, Этап, Игровой день — one-to-one with `CONTEXT.md`, kid-worded definitions. (ROADMAP §2.5, §4.2; ADR-0004)
